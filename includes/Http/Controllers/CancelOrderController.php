...
class CancelOrderController extends Controller
{
    ...
    public function handle($request){
        ...
        if (array_key_exists("fewer_transaction_id", $body)) {
            $transaction_details = $this->check_transaction_status( $body['fewer_transaction_id'] );
...
//                $transaction_details['status'] != 'fail'
    ...
    private function check_transaction_status($fewer_transaction_id)
    {
